...
os.startfile('C:\Program Files (x86)\Sanford Health\One Chart\One Chart.ica')
...
# Change this click location for other reports. click EQUIP Rad Feedback  Report.
pyautogui.click(1706, 236)
