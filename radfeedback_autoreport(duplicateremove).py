...
# Wait 3 minutes for report to generate before trying to export.
pyautogui.PAUSE = 180
# Change this click location for other reports. click EQUIP Rad Feedback 7  Report.
pyautogui.click(862, 277)
